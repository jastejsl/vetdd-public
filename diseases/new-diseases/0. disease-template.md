...
(insert the layman/common name for this disease if any)
...
(insert details in parahraph/detail form of pathology that results from this disease)
...
Insert any other details not covered by the above sections you feel important to note

### Related Academic Journals/Articles

Insert links to the sources used
